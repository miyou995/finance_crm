...
urlpatterns = [
    ...
    path(
        ...
        DeleteBulkInvoices.as_view(),
        name="bulk_delete_invoices",
    ),
    path("invoices/<int:pk>/", InvoiceDetailView.as_view(), name="detail_invoice"),
    path(
        "invoices/print_invoice_pdf/<int:invoice_id>/",
        print_invoice_pdf,
        name="print_invoice_pdf",
    ),
    path(
        "invoices/company/<int:pk>/",
        CompanyInvoicesTable.as_view(),
    ...
    path(
        "invoices/import-fields/",
        ImportFieldsInvoice.as_view(),
        name="import_fields_invoice",
    ),
    ############## Quotes ################
    path("quotes/", QuoteListView.as_view(), name="list_quote"),
    path(
        "quotes/company/<int:pk>/", CompanyQuotesTable.as_view(), name="company_quotes"
    ),
    path("quotes/create/", ManageQuoteHTMX.as_view(), name="create_quote"),
    path(
        "quotes/create/<int:company_pk>/",
        ManageQuoteHTMX.as_view(),
        name="create_company_quote",
    ),
    ...
    path(
        "quotes/print_quote_pdf/<int:quote_id>/",
        print_quote_pdf,
        name="print_quote_pdf",
    ),
    path(
        "quotes/convert/<int:quote_id>/",
        convert_quote_to_invoice,
    ...
    path(
        "quotes/import-fields/", ImportFieldsQuote.as_view(), name="import_fields_quote"
    ),
]
